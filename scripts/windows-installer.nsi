...
!define HELPURL "https://github.com/AICHAIN-CORE/mist/releases/issues"
!define UPDATEURL "https://github.com/AICHAIN-CORE/mist/releases"
!define ABOUTURL "https://aichain.me"
...
!macro ENVFUNC un
  Function ${un}setenv
    ...
    StrCpy $NODEDATADIR "$APPDATA\AICHAIN"
...
Section Mist MIST_IDX
    ...
    ## Firewall - add rules
    #SimpleFC::AdvAddRule "Gait incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$DATADIR\binaries\Geth\unpacked\gait.exe" "" "" "AICHAIN" 30303 "" "" ""
    #SimpleFC::AdvAddRule "Gait outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$DATADIR\binaries\Geth\unpacked\gait.exe" "" "" "AICHAIN" "" 30303 "" ""
    #SimpleFC::AdvAddRule "Gait UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$DATADIR\binaries\Geth\unpacked\gait.exe" "" "" "AICHAIN" "" 30303 "" ""
